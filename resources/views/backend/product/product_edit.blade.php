...
<div class="container-full">
                                    ...
                                    <div class="col-12">
                                                    ...
                                                    <div class="controls">
                                                        <select name="brand_id" class="form-control" required="">
                                                            ...
                                                            <option value="{{ $brand->id }}"
                                                                ...
                                                                {{ $brand->brand_name_en }}</option> @endforeach
                                                        </select>
                                                        @error('brand_id')
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Product Name nl <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_name_nl" class="form-control"
                                                            required="" value="{{ $products->product_name_nl }}">
                                                        @error('product_name_nl')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Product Tags nl <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_tags_nl" class="form-control"
                                                            value="{{ $products->product_tags_nl }}"
                                                            data-role="tagsinput" required="">
                                                        @error('product_tags_nl')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="product_size_nl" class="form-control"
                                                            value="{{ $products->product_size_nl }}"
                                                            data-role="tagsinput">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <h5>Product Color nl <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <input type="text" name="product_color_nl" class="form-control"
                                                            value="{{ $products->product_color_nl }}"
                                                            data-role="tagsinput">
                                                        @error('product_color_nl')
                                                        <span class="text-danger">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Short Description dutch <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <textarea name="short_descp_nl" id="textarea"
                                                            class="form-control" required
                                                            placeholder="Textarea text">{!! $products->short_descp_nl !!}</textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <h5>Long Description Dutch <span class="text-danger">*</span></h5>
                                                    <div class="controls">
                                                        <textarea id="editor2" name="long_descp_nl" rows="10" cols="80">
													{!! $products->long_descp_nl !!}
						</textarea>
                                                    </div>
                                                </div>
    ...
    <!-- ///////////////// Start Thumbnail Image Update Area (geen delete optie omdat er altijd een thumbnail moet zijn) ///////// -->
