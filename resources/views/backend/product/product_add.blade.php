...
<div class="row"> <!-- start 2nd row  -->
	...
	<div class="controls">
	 ...
	 @enderror
			...
			<div class="controls">
				<input type="text" name="product_name_nl" class="form-control" required="">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_tags_nl" class="form-control" value="Lorem,Ipsum,Amet" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 5th row  -->
	 ...
	 @enderror
			...
			<div class="controls">
	 <input type="text" name="product_color_nl" class="form-control" value="red,Black,Large" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 7th row  -->
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>     
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_nl" id="textarea" class="form-control" required placeholder="Textarea text"></textarea>     
	 		 </div>
		</div>
